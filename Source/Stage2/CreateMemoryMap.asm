...
CreateMemoryMap:
	...
	mov dword [MEMORY_MAP_LOCATION+4], 0x0000000000000000
	; Set di to MEMORY_MAP_LOCATION. Otherwise this code will get stuck in
...
.skipent:
	...
	jne short .e820lp
.e820f:
	mov [MEMORY_MAP_LOCATION], bp		; store the entry count
	popa
